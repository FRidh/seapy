...
def main():
    ...
    steel = system1.addMaterial('steel', 'MaterialSolid', young=1.0e7, poisson=0.30, loss_factor=0.02)
    ...
    connection1 = system1.addConnection('connection1', 'Connection')
    connection1.addComponent(beam1, 'corner')
    connection1.addComponent(beam2, 'corner')
    print connection1.components
    """Add couplings between subsystems"""
    connection1.addCouplings()
