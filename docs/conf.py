...
latex_documents = [
    ("index", "SeaPy.tex", u"SeaPy Documentation", u"Frederik Rietdijk", "manual"),
]
...
man_pages = [("index", "seapy", u"SeaPy Documentation", [u"Frederik Rietdijk"], 1)]
